...
To aid the making of design desicisions, our group attempted to distill and combine Shneiderman's Principles of Interaction Design, Don Norman's Design Principles and Tog's First Principles of Interaction Design in order to make them easier to work with. These criteria have be identified as a solid starting point for any user interface.
